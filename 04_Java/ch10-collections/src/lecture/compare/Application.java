...
//        });
        ...
        // 람다로 Comparator 구현
        Set<Student> students2 = new TreeSet<>((o1, o2) -> o1.getName().compareTo(o2.getName()));
        ...
        for (Student s : list) {
            // 팀명이 나올 때마다 기존 value에 누적
            teamCount.put(
                    s.getTeam(),
                    // 키에 해당하는 값이 있으면 값 반환, 없으면 기본값 반환
        ...
        // Map은 Iterator 사용 불가능 -> Set으로 변환 후 사용
        // Map에 저장된 모든 key를 Set 형태로 변환
