...
public class MovieAnalysis {
    ...
    public static void main(String[] args) {
        ...
        // 결과 : [SF, 드라마, 액션]
        List<String> highRatedGenres = movies.stream()
                .filter(m -> m.getRating() >= 8.5)
                .map(Movie::getGenre)
                .distinct()
                .sorted()
                .toList();
        System.out.println(highRatedGenres);
    }
}
