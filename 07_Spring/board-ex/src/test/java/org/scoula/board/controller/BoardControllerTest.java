...
class BoardControllerTest {
    ...
    @Autowired
    WebApplicationContext ctx; // 웹 어플리케이션 컨텍스트 -> MockMvc 만들 때 기반으로 사용됨
    ...
    void list() throws Exception {
        // mockMvc.perform: 테스트 코드에서 브라우저 대신 컨트롤러에 HTTP 요청을 보내는 메서드
        log.info(String.valueOf(
                mockMvc.perform(
                        MockMvcRequestBuilders
                                .get("/board/list")) // ResultActions 리턴
