...
class RootConfigTest {
    ...
    public void testPool() throws SQLException {
        ...
        log.info("[시작] total=" + pool.getTotalConnections() // 총 Connection 개수
                + ", active=" + pool.getActiveConnections() // 사용중인 Connection 개수
                + ", idle=" + pool.getIdleConnections()); // 대기중인 Connection 개수
