  ...
  <div class="mt-5 mx-auto" style="width: 500px">
    ...
    <form @submit.prevent="join">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" placeholder="사용자 ID" id="username" @input="changeUsername"
          v-model="member.username" required />
      </div>
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="email" class="form-control" placeholder="Email" id="email" v-model="member.email" required />
      </div>
...
const changeUsername = () => {
  disableSubmit.value = true; // 제출 버튼 활성화
  checkError.value = member.username ? "ID 중복 체크를 해야 합니다!" : "";
};
